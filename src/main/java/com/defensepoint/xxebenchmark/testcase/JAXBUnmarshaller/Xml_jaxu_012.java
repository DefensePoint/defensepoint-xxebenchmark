...
@Component
public class Xml_jaxu_012 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_jaxu_012.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_jaxu_012");

        String testId = "xml-jaxu-" + OSUtil.getOS() + "-" + System.getProperty("java.version") + "-012";
        ...
        try {
            ...
            File xmlFile = new File(Objects.requireNonNull(classLoader.getResource("xml/localFileInclusionNote.xml")).getFile());
