...
//@Component
public class Xml_sb_007 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_sb_007.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_sb_007");

        String testId = "xml-sb-" + OSUtil.getOS() + "-" + System.getProperty("java.version") + "-007";
