...
//@Component
public class Xml_sb_013 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_sb_013.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_sb_013");

        String testId = "xml-sb-" + OSUtil.getOS() + "-" + System.getProperty("java.version") + "-013";
