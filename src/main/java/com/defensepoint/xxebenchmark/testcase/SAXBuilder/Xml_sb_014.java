...
//@Component
public class Xml_sb_014 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_sb_014.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_sb_014");

        String testId = "xml-sb-" + OSUtil.getOS() + "-" + System.getProperty("java.version") + "-014";
