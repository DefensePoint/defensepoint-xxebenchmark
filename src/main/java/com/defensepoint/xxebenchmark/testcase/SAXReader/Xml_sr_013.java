...
@Component
public class Xml_sr_013 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_sr_013.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_sr_013");

        String testId = "xml-sr-" + OSUtil.getOS() + "-" + System.getProperty("java.version") + "-013";
