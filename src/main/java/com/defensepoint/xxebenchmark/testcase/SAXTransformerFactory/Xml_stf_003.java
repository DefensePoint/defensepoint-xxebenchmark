...
@Component
public class Xml_stf_003 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_stf_003.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_stf_003");

        Thread th = new Thread ( new Xml_stf_003_thread() , "Xml_stf_003_thread");
        th.start();
...
class Xml_stf_003_thread implements Runnable {

    private static final Logger logger = LoggerFactory.getLogger(Xml_stf_003_thread.class);
