...
@Component
public class Xml_stf_018 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_stf_018.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_stf_018");

        String testId = "xml-stf-" + OSUtil.getOS() + "-" + System.getProperty("java.version") + "-018";
