...
@Component
public class Xml_sf_006 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_sf_006.class);

    //@PostConstruct
    public void validate() {

        logger.info("Xml_sf_006");

        String testId = "xml-sf-" + OSUtil.getOS() + "-" + JavaUtil.getJavaVersion() + "-006";
