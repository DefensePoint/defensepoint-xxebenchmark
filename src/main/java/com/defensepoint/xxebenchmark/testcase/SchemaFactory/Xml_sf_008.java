...
@Component
public class Xml_sf_008 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_sf_008.class);

    //@PostConstruct
    public void validate() {

        logger.info("Xml_sf_008");

        String testId = "xml-sf-" + OSUtil.getOS() + "-" + JavaUtil.getJavaVersion() + "-008";
