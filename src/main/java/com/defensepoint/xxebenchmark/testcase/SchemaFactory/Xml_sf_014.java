...
//@Component
public class Xml_sf_014 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_sf_014.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_sf_014");

        String testId = "xml-sf-" + OSUtil.getOS() + "-" + JavaUtil.getJavaVersion() + "-014";
