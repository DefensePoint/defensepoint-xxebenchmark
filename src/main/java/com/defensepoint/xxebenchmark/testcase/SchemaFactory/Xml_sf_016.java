...
//@Component
public class Xml_sf_016 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_sf_016.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_sf_016");

        String testId = "xml-sf-" + OSUtil.getOS() + "-" + JavaUtil.getJavaVersion() + "-016";
