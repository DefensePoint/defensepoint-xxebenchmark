...
//@Component
public class Xml_sf_019 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_sf_019.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_sf_019");

        String testId = "xml-sf-" + OSUtil.getOS() + "-" + JavaUtil.getJavaVersion() + "-019";
