...
//@Component
public class Xml_sf_020 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_sf_020.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_sf_020");

        String testId = "xml-sf-" + OSUtil.getOS() + "-" + JavaUtil.getJavaVersion() + "-020";
