...
public class Xml_tf_001 {
    ...
    public void parse() {
        ...
        Thread th = new Thread ( new Xml_tf_001_thread() , "Xml_tf_001_thread");
        th.start();
...
class Xml_tf_001_thread implements Runnable {

    private static final Logger logger = LoggerFactory.getLogger(Xml_tf_001_thread.class);
