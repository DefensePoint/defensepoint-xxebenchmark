...
@Component
public class Xml_tf_006 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_tf_006.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_tf_006");

        String testId = "xml-tf-" + OSUtil.getOS() + "-" + System.getProperty("java.version") + "-006";
