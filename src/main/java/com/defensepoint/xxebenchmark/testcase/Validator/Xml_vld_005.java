...
@Component
public class Xml_vld_005 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_vld_005.class);

    //@PostConstruct
    public void validate() {

        logger.info("Xml_vld_005");

        String testId = "xml-vld-" + OSUtil.getOS() + "-" + JavaUtil.getJavaVersion() + "-005";
