...
//@Component
public class Xml_vld_007 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_vld_007.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_vld_007");

        String testId = "xml-vld-" + OSUtil.getOS() + "-" + JavaUtil.getJavaVersion() + "-007";
        ...
        try {
            ...
            File xmlFile = new File(Objects.requireNonNull(classLoader.getResource("xml/userWithLocalSchemaDtd.xml")).getFile());
