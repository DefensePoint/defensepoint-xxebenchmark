...
//@Component
public class Xml_vld_009 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_vld_009.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_vld_009");

        String testId = "xml-vld-" + OSUtil.getOS() + "-" + JavaUtil.getJavaVersion() + "-009";
