...
//@Component
public class Xml_vld_010 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_vld_010.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_vld_010");

        String testId = "xml-vld-" + OSUtil.getOS() + "-" + JavaUtil.getJavaVersion() + "-010";
        String testName = "Remote Schema / FEATURE_SECURE_PROCESSING is enabled";
        ...
        try {
            ...
            InputStream xmlFile = classLoader.getResourceAsStream("xml/userWithRemoteSchemaDtd.xml");
