...
//@Component
public class Xml_vld_011 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_vld_011.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_vld_011");

        String testId = "xml-vld-" + OSUtil.getOS() + "-" + JavaUtil.getJavaVersion() + "-011";
