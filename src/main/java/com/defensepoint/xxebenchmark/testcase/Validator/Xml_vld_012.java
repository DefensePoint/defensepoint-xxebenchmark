...
@Component
public class Xml_vld_012 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_vld_012.class);

    //@PostConstruct
    public void validate() {

        logger.info("Xml_vld_012");

        String testId = "xml-vld-" + OSUtil.getOS() + "-" + JavaUtil.getJavaVersion() + "-012";
