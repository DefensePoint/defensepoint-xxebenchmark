...
@Component
public class Xml_vld_013 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_vld_013.class);

    //@PostConstruct
    public void validate() {

        logger.info("Xml_vld_013");

        String testId = "xml-vld-" + OSUtil.getOS() + "-" + JavaUtil.getJavaVersion() + "-013";
        ...
        try {
            ...
            File xmlFile = new File(Objects.requireNonNull(classLoader.getResource("xml/userRemoteFileInclusion.xml")).getFile());
