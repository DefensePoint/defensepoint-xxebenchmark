...
//@Component
public class Xml_vld_016 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_vld_016.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_vld_016");

        String testId = "xml-vld-" + OSUtil.getOS() + "-" + JavaUtil.getJavaVersion() + "-016";
