...
@Component
public class Xml_xif_005 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_xif_005.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_xif_005");

        String testId = "xml-xif-" + OSUtil.getOS() + "-" + System.getProperty("java.version") + "-005";
