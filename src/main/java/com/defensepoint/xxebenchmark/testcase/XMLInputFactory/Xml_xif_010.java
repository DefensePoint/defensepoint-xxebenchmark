...
//@Component
public class Xml_xif_010 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_xif_010.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_xif_010");

        String testId = "xml-xif-" + OSUtil.getOS() + "-" + System.getProperty("java.version") + "-010";
        String testName = "Remote Schema / External entities and DTDs are disabled";
