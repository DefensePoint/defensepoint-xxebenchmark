...
@Component
public class Xml_xr_005 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_xr_005.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_xr_005");

        String testId = "xml-xr-" + OSUtil.getOS() + "-" + System.getProperty("java.version") + "-005";
