...
//@Component
public class Xml_xr_010 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_xr_010.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_xr_010");

        String testId = "xml-xr-" + OSUtil.getOS() + "-" + System.getProperty("java.version") + "-010";
