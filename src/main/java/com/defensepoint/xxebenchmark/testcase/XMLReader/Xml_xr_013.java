...
//@Component
public class Xml_xr_013 {
    private static final Logger logger = LoggerFactory.getLogger(Xml_xr_013.class);

    //@PostConstruct
    public void parse() {

        logger.info("Xml_xr_013");

        String testId = "xml-xr-" + OSUtil.getOS() + "-" + System.getProperty("java.version") + "-013";
